...
import (
	...
	snapshots "github.com/fairwindsops/photon/pkg/types/snapshotgroup/v1"
)
...
type fixture struct {
	...
	sgLister []*snapshots.SnapshotGroup
...
func newSnapshotGroup(name string) *snapshots.SnapshotGroup {
	return &snapshots.SnapshotGroup{
		TypeMeta: metav1.TypeMeta{APIVersion: snapshots.SchemeGroupVersion.String()},
		ObjectMeta: metav1.ObjectMeta{
			Name:      name,
			Namespace: metav1.NamespaceDefault,
		},
		Spec: snapshots.SnapshotGroupSpec{},
	}
}
...
func (f *fixture) runController(fooName string, startInformers bool, expectError bool) {
	...
	item := workItem{
		name:          "thing",
		namespace:     "foo",
		snapshotGroup: &snapshots.SnapshotGroup{},
		task:          backupTask,
	}
...
func (f *fixture) expectUpdateSnapshotGroupStatusAction(foo *snapshots.SnapshotGroup) {
...
func getKey(foo *snapshots.SnapshotGroup, t *testing.T) string {
